...
declare const _default: ComponentMeta<({ iconType, icon, ...rest }: import("./Icon").IconProps) => JSX.Element>;
export default _default;
export declare const List: ComponentStory<({ iconType, icon, ...rest }: import("./Icon").IconProps) => JSX.Element>;
export declare const Sort: ComponentStory<({ iconType, icon, ...rest }: import("./Icon").IconProps) => JSX.Element>;
