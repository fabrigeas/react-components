...
var Button = function (_a) {
    ...
    return (jsx("button", __assign({ "data-testid": testId$1, type: type, className: "Button ".concat(buttonType, " ").concat(outlined ? 'outlined' : '', " ").concat(className !== null && className !== void 0 ? className : '') }, rest)));
};
...
var Input = function (_a) {
    ...
    return (jsxs("div", __assign({ "data-testid": testId, className: "Input ".concat(validClass, " ").concat((_b = props.type) !== null && _b !== void 0 ? _b : 'text') }, { children: [label && (jsx("label", __assign({ className: "form-label", htmlFor: id }, { children: label }))), textarea ? (jsx("textarea", __assign({ id: id, className: classList }, props, { style: { height: 'unset !important' } }))) : (jsx("input", __assign({ id: id, className: classList }, props))), jsx("div", __assign({ "data-testid": "feedback", className: "".concat(isValid ? 'valid' : 'invalid', "-feedback") }, { children: isValid ? validFeedback : invalidFeedback }))] })));
};
