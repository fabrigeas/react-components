...
var Button = function (_a) {
    var className = _a.className, _b = _a.buttonType, buttonType = _b === void 0 ? 'info' : _b, outlined = _a.outlined, rest = __rest(_a, ["className", "buttonType", "outlined"]);
    return (jsx("button", __assign({ "data-testid": testId$3, className: "Button ".concat(buttonType, " ").concat(outlined ? 'outlined' : '', " ").concat(className !== null && className !== void 0 ? className : '') }, rest)));
};
...
var Icon = function (_a) {
    ...
    var iconDict = {
        list: jsx("span", { children: "\u2630" }),
        sort: jsx("span", { children: "\u21C5" }),
        trash: jsx("span", { children: "\uD83D\uDDD1" }),
        home: jsx("span", { children: "\uD83C\uDFE0" }),
        next: jsx("span", { children: ">" }),
    };
    return (jsx("span", __assign({ className: "Icon ".concat(iconType) }, rest, { children: iconDict[icon] })));
};
...
var ToastNotification = function (_a) {
    ...
    return (jsxs("div", __assign({ id: id, className: className, role: "alert", "aria-live": "assertive", "aria-atomic": true, "data-testid": testId$1, style: {
            maxWidth: '50vw',
            right: 0,
        } }, { children: [jsxs("div", __assign({ className: "header" }, { children: [jsx("strong", __assign({ className: "title" }, { children: title })), time && jsx("small", __assign({ className: "time" }, { children: time })), jsx("button", __assign({ type: "button", className: "close", "data-dismiss": "toast", "aria-label": "Close", onClick: function () { return destroy(message); } }, { children: jsx("span", __assign({ "aria-hidden": "true" }, { children: "\u00D7" })) }))] })), content && jsx("div", __assign({ className: "content" }, { children: content })), jsx("div", __assign({ className: "footer" }, { children: jsx("div", { className: "progressBar" }) }))] })));
};
...
var ToastNotificationList = function (_a) {
    ...
    return (jsx("div", __assign({ className: "toast-notification-list", "data-testid": testId, style: {
            position: 'fixed',
            right: 0,
            top: 0,
            maxWidth: '50%',
            ...
            color: 'white',
            zIndex: 2,
        } }, { children: jsx("div", __assign({ className: "notification-list" }, { children: notifications.map(function (message, i) { return (jsx(ToastNotification, { message: message, destroy: destroy }, i)); }) })) })));
};

export { Button, Icon, Input, Spinner, ToastNotification, ToastNotificationList };
